...
data_dir = main_dir + "/data"   # specify directory here 
...
for i in range(P):
    if i in include_3x2.index:
        port_3x2b.append(port_3x2.iloc[:,(i*6-5):(i*6)])
port_3x2b = np.concatenate(port_3x2b,axis=1)
...
for i in range(P):
    if i in include_5x5.index:
        port_5x5b.append(port_5x5.iloc[:,(i*6-5):(i*6)])
port_5x5b = np.concatenate(port_5x5b,axis=1)

#---------------------
# convert all data to NumPy arrays
port_5x5 = np.array(port_5x5)
port_3x2 = np.array(port_3x2)
port_202 = np.array(port_202)